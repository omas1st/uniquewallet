...
const Dashboard = () => {
  ...
  const handleAssetClick = (asset, amount) => {
    if(amount > 0.0001) {
      navigate(`/asset/${asset}`); // this can route to a detailed asset page if desired
    }
  };
    ...
    <div className="dashboard-container">
      ...
      <div className="assets-list">
        ...
        {userData && Object.entries(userData.portfolio).map(([asset, amount]) => (
          <div key={asset} className="asset-item" onClick={() => handleAssetClick(asset, amount)}>
