...
const SendPaymentPage = () => {
  ...
  const handleConfirmPayment = () => {
    // Simulate a failure for the send payment
  ...
  return (
    <div className="payment-container">
      ...
      <div className="payment-section bank-details">
        ...
        <p><strong>Note:</strong> Don't forget to add the “{bankDetails.reference}” as reference when making the payment.</p>
      </div>
