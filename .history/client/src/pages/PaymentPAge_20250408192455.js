...
const PaymentPage = () => {
  ...
  // For Buy, we expect asset and amount from location.state
  ...
  return (
    <div className="payment-container">
      ...
      <div className="payment-section summary-section">
        ...
        {asset && amount && (
          <div>
            ...
            <p><strong>Amount to Pay:</strong> R {amount}</p>
          </div>
        )}
      </div>
      ...
      <div className="payment-section bank-details">
        ...
        <p>
          <strong>Note:</strong> Don't forget to add “{bankDetails.reference}” as reference when making the payment.
        </p>
      </div>
